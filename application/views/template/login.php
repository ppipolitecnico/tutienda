                    ...
                    <div class="panel-body">
                            ...
                            <fieldset>
                                <div class="form-group">
                                    <input class="form-control" value="<?= set_value('user'); ?>" placeholder="E-mail" name="user" autofocus required>
                                </div>
                                <div class="form-group">
                                    <input class="form-control" value="<?= set_value('pass'); ?>" placeholder="Password" name="pass" type="password" required>
                                </div>
                                <div class="checkbox">
                                    <label>
